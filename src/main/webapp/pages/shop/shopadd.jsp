...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body" style="padding: 15px;">
        ...
        <div style="width: 650px; position: relative; left:25%; padding-top: 20px">
            <form class="layui-form" action="shopadd" method="post" >

                <div class="layui-form-item" style="padding-bottom: 10px">
                    <label class="layui-form-label">
                        <span style="color: red">*</span>商铺名</label>
                    <div class="layui-input-block">
                        <input type="text" name="name" required  lay-verify="required" placeholder="请输入商铺名" autocomplete="off" class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item" style="padding-bottom:10px">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" lay-verify="number" name="score" required  lay-verify="required" placeholder="请输入初始评分" autocomplete="off" class="layui-input">
                    </div>
                </div>
