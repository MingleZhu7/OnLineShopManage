...
<div style="width: 400px; position: relative; left:15%; padding-top: 20px">
    <form class="layui-form" action="goodsloadup" method="post" >
        <div class="layui-form-item" style="padding-bottom: 10px">
            <input type="hidden" name="Gid" value="${Gid}"/>
            <label class="layui-form-label">
                <span style="color: red">*</span>商铺</label>
            <div class="layui-input-inline">
                <select name="shopName" lay-verify="required">
                    <option value="">请选择上架的商铺</option>
...
<script>
    ...
    if(hasLoadUp == "true"){
        layer.msg("该商品名已在该店铺上架，上架失败", {icon: 2});
