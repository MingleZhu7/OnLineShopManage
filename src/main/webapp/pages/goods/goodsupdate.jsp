...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body" style="padding: 15px;">
        ...
        <div style="width: 650px; position: relative; left:25%; padding-top: 20px">
            <form class="layui-form" action="goodsupdate" method="post" >
                <input type="hidden" name="id" value="${goods.id}"/>
                <div class="layui-form-item" style="padding-bottom: 10px">
                    <label class="layui-form-label">
                        <span style="color: red">*</span>商品名</label>
                ...
                <div class="layui-form-item" style="padding-bottom:10px">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" lay-verify="number" name="price" required  value="${goods.price}"  lay-verify="required"  autocomplete="off" class="layui-input">
                    </div>
                    <div class="layui-form-mid layui-word-aux">单位为：元</div>
                </div>
                <div class="layui-form-item" style="padding-bottom: 10px">
                    <label class="layui-form-label">
                    ...
                    <div class="layui-input-block">
                        <select name="type" lay-verify="required">
                            <option value="${goods.type}" selected>${goods.type}</option>
