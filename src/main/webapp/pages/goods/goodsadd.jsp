...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body" style="padding: 15px;">
        ...
        <div style="width: 650px; position: relative; left:25%; padding-top: 20px">
            <form class="layui-form" action="goodsadd" method="post" >
                ...
                <div class="layui-form-item" style="padding-bottom:10px">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" lay-verify="number" name="price" required  lay-verify="required" placeholder="请输入价格" autocomplete="off" class="layui-input">
                    </div>
...
<script>
    ...
    if(existGoods == "true"){
        layer.msg("该商品名已经存在，请重新添加", {icon: 2});
    }
