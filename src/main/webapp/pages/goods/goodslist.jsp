...
<%--侧边栏--%>
    ...
    <div class="layui-body" style="padding: 15px;">
        ...
        <!-- 内容主体区域 -->
        <form class="layui-form" action="goodslist" method="post">
    ...
    <!--每条数据的操作栏-->
        ...
        <div class="layui-btn-container" style="padding: 15px;">
            <button class="layui-btn layui-btn-sm"  onclick="location.href='goodsadd'">添加</button>
        </div>
...
<script type="text/html" id="barDemo">
    <a class="layui-btn layui-btn-normal layui-btn-sm" lay-event="loadup">上架</a>
        ...
        table.on('tool(demo)', function(obj){
            ...
            if(obj.event === 'del'){
                layer.confirm('真的删除要删除吗', function(index){
                    ...
                    // 调用删除方法
                    window.location.href="goodsdel?id="+data.id;
                });
